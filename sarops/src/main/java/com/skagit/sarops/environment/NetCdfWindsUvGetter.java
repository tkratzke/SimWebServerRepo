 ...
 */
public class NetCdfWindsUvGetter extends NetCdfUvGetter implements WindsUvGetter {
	final private SimCaseManager.SimCase _simCase;
	private boolean _haveLoggedInvalid;

	public NetCdfWindsUvGetter(final SimCaseManager.SimCase simCase, final Model model, final String fileName,
			final double dU, final double dV, final double altDU, final double altDV, final long halfLifeSecs,
			final long preDistressHalfLifeSecs, final boolean dataIsDownWind) {//
		super(simCase, model, _WindsTag, fileName, new String[] {
				"U", "u", "wind_u"
		}, //
				new String[] {
						"V", "v", "wind_v"
				...
				new String[] {
						"Dir", "dir", "Direction", "direction", "wind_dir"
				}, //
				new String[] {
						"U_Unc", "u_Unc", "u_unc", "wind_u_Unc"
				}, //
				new String[] {
						"V_Unc", "v_Unc", "v_unc", "wind_v_Unc"
				}, //
				new String[] {
						"U_AltUnc", "u_AltUnc", "u_Altunc", "wind_u_AltUnc"
				}, //
				new String[] {
						"V_AltUnc", "v_AltUnc", "v_Altunc", "wind_v_AltUnc"
				}, //
				new String[] {}, //
				new String[] {}, //
				new String[] {}, //
	...
	public NetCdfWindsUvGetter(final SimCaseManager.SimCase simCase, final Model model, final String nominalFileName,
			final NetcdfFile netCdfFile, final double dU, final double dV, final double altDU, final double altDV,
		...
		super(simCase, model, _WindsTag, nominalFileName, netCdfFile, new String[] {
				"U", "u", "wind_u"
		}, new String[] {
				"V", "v", "wind_v"
		}, new String[] {
				...
				"V_AltUnc", "v_AltUnc", "v_Altunc", "wind_altv_Unc"
		}, new String[] {}, new String[] {}, new String[] {}, dU, dV, altDU, altDV, halfLifeSecs,
				preDistressHalfLifeSecs, useStandardDirection);
		_simCase = simCase;
		_haveLoggedInvalid = false;
	}
	...
	public DataForOnePointAndTime getDownWindData(final long refSecs, final LatLng3 latLng,
		...
		final DataForOnePointAndTime data = getDataForOnePointAndTime(_simCase, refSecs, latLng, interpolationMode);
		return data;
	}
	...
	public boolean isEmpty(final MyLogger logger) {
		...
		if (empty && !_haveLoggedInvalid) {
			MyLogger.err(logger, "Invalid Winds UvGetter!");
